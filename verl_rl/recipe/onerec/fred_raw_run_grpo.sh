...
BASE_MODEL=/nvme3n1p1/fredhong/hf_home/OneRec-8B-pro
DATA_DIR=/nvme3n1p1/fredhong/fred_fork_vllm_gr/vllm_gr_v2_fred_fork/working_branch_fredfork_openonerec/output/rl_data
TRAIN_FILES=${TRAIN_FILES:-"[$DATA_DIR/train_1k.parquet]"}
VAL_FILES=${VAL_FILES:-"[$DATA_DIR/test.parquet]"}
N_NODES=1
N_GPUS=4
ENABLE_THINK=True
OPENIF_PRODUCT_PARQUET_SOURCE=data_source
ROLLOUT_TP_SIZE=2
train_tp=1
...
PROJECT_DIR=/home/fredhong/vllm_fork_genrec_workspace/fred_fork_openonerec/working_branch_fredfork_openonerec
